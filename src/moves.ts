...
// ---- footwork tier (leg-dominant — legs carry the move, arms style it) -----
def('stomp_l',    0.6,  { lean: 3, crouch: 0.1, armL: [30, 60], armR: [30, 60], legL: [55, 70], legR: [12, 8] });
def('stomp_r',    0.6,  { lean: -3, crouch: 0.1, armL: [30, 60], armR: [30, 60], legL: [12, 8], legR: [55, 70] });
def('heel_l',     0.45, { lean: 4, armL: [45, 115], armR: [45, 115], legL: [38, 2], legR: [10, 6] });
def('heel_r',     0.45, { lean: -4, armL: [45, 115], armR: [45, 115], legL: [10, 6], legR: [38, 2] });
def('toe_tap_l',  0.4,  { lean: 6, armL: [20, 40], armR: [70, 50], legL: [42, 8], legR: [10, 4] });
def('toe_tap_r',  0.4,  { lean: -6, armL: [70, 50], armR: [20, 40], legL: [10, 4], legR: [42, 8] });
def('grapevine_l', 0.65, { lean: -12, armL: [85, 5], armR: [85, 5], legL: [46, 4], legR: [8, 20] });
def('grapevine_r', 0.65, { lean: 12, armL: [85, 5], armR: [85, 5], legL: [8, 20], legR: [46, 4] });
def('charleston_l', 0.75, { lean: -6, armL: [60, 40], armR: [25, 70], legL: [-18, 65], legR: [12, 6] });
def('charleston_r', 0.75, { lean: 6, armL: [25, 70], armR: [60, 40], legL: [12, 6], legR: [-18, 65] });
def('lunge_fwd_l', 0.8, { lean: -5, crouch: 0.3, armL: [75, 10], armR: [75, 10], legL: [48, 55], legR: [-14, 12] });
def('lunge_fwd_r', 0.8, { lean: 5, crouch: 0.3, armL: [75, 10], armR: [75, 10], legL: [-14, 12], legR: [48, 55] });
def('lunge_back_l', 0.7, { lean: 6, crouch: 0.25, armL: [110, 20], armR: [40, 30], legL: [-22, 30], legR: [30, 40] });
def('lunge_back_r', 0.7, { lean: -6, crouch: 0.25, armL: [40, 30], armR: [110, 20], legL: [30, 40], legR: [-22, 30] });
def('squat_hold', 0.75, { crouch: 0.5, armL: [70, 15], armR: [70, 15], legL: [34, 48], legR: [34, 48] });
def('squat_side_l', 0.7, { lean: -10, crouch: 0.35, armL: [55, 90], armR: [55, 90], legL: [48, 30], legR: [16, 10] });
def('squat_side_r', 0.7, { lean: 10, crouch: 0.35, armL: [55, 90], armR: [55, 90], legL: [16, 10], legR: [48, 30] });
def('hop_l',      0.8,  { armL: [65, 100], armR: [65, 100], legL: [60, 85], legR: [8, 4], arrowL: 'up', arrowR: 'up' });
def('hop_r',      0.8,  { armL: [65, 100], armR: [65, 100], legL: [8, 4], legR: [60, 85], arrowL: 'up', arrowR: 'up' });
def('side_kick_l', 0.8, { lean: 8, armL: [90, 0], armR: [90, 0], legL: [62, 4], legR: [10, 8], arrowL: 'out' });
def('side_kick_r', 0.8, { lean: -8, armL: [90, 0], armR: [90, 0], legL: [10, 8], legR: [62, 4], arrowR: 'out' });
def('back_kick_l', 0.6, { lean: -4, armL: [50, 80], armR: [50, 80], legL: [-8, 115], legR: [12, 6] });
def('back_kick_r', 0.6, { lean: 4, armL: [50, 80], armR: [50, 80], legL: [12, 6], legR: [-8, 115] });
def('knee_cross_l', 0.75, { lean: 8, armL: [40, 110], armR: [110, 90], legL: [58, 95], legR: [10, 6] });
def('knee_cross_r', 0.75, { lean: -8, armL: [110, 90], armR: [40, 110], legL: [10, 6], legR: [58, 95] });
def('high_knee_l', 0.85, { armL: [30, 95], armR: [70, 95], legL: [80, 95], legR: [10, 4], arrowL: 'up' });
def('high_knee_r', 0.85, { armL: [70, 95], armR: [30, 95], legL: [10, 4], legR: [80, 95], arrowR: 'up' });
def('hamstring_l', 0.6, { lean: 2, armL: [60, 105], armR: [60, 105], legL: [4, 120], legR: [14, 8] });
def('hamstring_r', 0.6, { lean: -2, armL: [60, 105], armR: [60, 105], legL: [14, 8], legR: [4, 120] });
def('skater_l',   0.85, { lean: -14, crouch: 0.35, armL: [100, 15], armR: [30, 95], legL: [40, 45], legR: [-20, 40] });
def('skater_r',   0.85, { lean: 14, crouch: 0.35, armL: [30, 95], armR: [100, 15], legL: [-20, 40], legR: [40, 45] });
def('jumping_jack', 0.95, { armL: [120, 0], armR: [120, 0], legL: [38, 0], legR: [38, 0], arrowL: 'up', arrowR: 'up' });
def('ski_hop',    0.8,  { lean: -8, crouch: 0.28, armL: [40, 95], armR: [40, 95], legL: [22, 35], legR: [22, 35] });
def('cha_cha_l',  0.55, { lean: -8, crouch: 0.12, armL: [50, 100], armR: [80, 80], legL: [30, 20], legR: [10, 12] });
def('cha_cha_r',  0.55, { lean: 8, crouch: 0.12, armL: [80, 80], armR: [50, 100], legL: [10, 12], legR: [30, 20] });
def('moonwalk_l', 0.6,  { lean: 7, armL: [15, 10], armR: [15, 10], legL: [4, 40], legR: [22, 4] });
def('moonwalk_r', 0.6,  { lean: -7, armL: [15, 10], armR: [15, 10], legL: [22, 4], legR: [4, 40] });
def('pivot_l',    0.55, { lean: -10, armL: [45, 120], armR: [45, 120], legL: [26, 12], legR: [2, 30] });
def('pivot_r',    0.55, { lean: 10, armL: [45, 120], armR: [45, 120], legL: [2, 30], legR: [26, 12] });
def('can_can_l',  0.9,  { lean: 6, armL: [95, 20], armR: [95, 20], legL: [85, 8], legR: [10, 6], arrowL: 'up' });
def('can_can_r',  0.9,  { lean: -6, armL: [95, 20], armR: [95, 20], legL: [10, 6], legR: [85, 8], arrowR: 'up' });
def('stomp_clap', 0.8,  { crouch: 0.08, armL: [150, 20], armR: [150, 20], legL: [50, 60], legR: [12, 8], arrowL: 'up', arrowR: 'up' });
def('calf_raise', 0.45, { armL: [160, 5], armR: [160, 5], legL: [6, 2], legR: [6, 2] });
def('march_l',    0.6,  { armL: [25, 95], armR: [55, 95], legL: [50, 80], legR: [10, 6] });
def('march_r',    0.6,  { armL: [55, 95], armR: [25, 95], legL: [10, 6], legR: [50, 80] });
def('kick_fwd_l', 0.7,  { lean: 3, armL: [70, 30], armR: [70, 30], legL: [45, 6], legR: [10, 6], arrowL: 'up' });
def('kick_fwd_r', 0.7,  { lean: -3, armL: [70, 30], armR: [70, 30], legL: [10, 6], legR: [45, 6], arrowR: 'up' });
// ---- extra flavor moves ----------------------------------------------------
def('salute',     0.5,  { lean: -3, armL: [15, 10], armR: [115, 125], legL: STANCE, legR: STANCE });
def('bow_deep',   0.5,  { crouch: 0.2, armL: [40, 20], armR: [100, 30], legL: [16, 14], legR: [16, 14] });
def('frame_face', 0.45, { armL: [95, 120], armR: [95, 120], legL: WIDE, legR: WIDE });
def('shrug',      0.35, { armL: [55, 130], armR: [55, 130], legL: STANCE, legR: STANCE });
def('lookout_l',  0.5,  { lean: -6, armL: [100, 105], armR: [25, 30], legL: WIDE, legR: WIDE });
def('lookout_r',  0.5,  { lean: 6, armL: [25, 30], armR: [100, 105], legL: WIDE, legR: WIDE });
def('heart_hands', 0.55, { armL: [120, 85], armR: [120, 85], legL: WIDE, legR: WIDE, arrowL: 'in', arrowR: 'in' });
def('bicep_flex_l', 0.5, { lean: -5, armL: [95, 105], armR: [25, 15], legL: WIDE, legR: WIDE });
def('bicep_flex_r', 0.5, { lean: 5, armL: [25, 15], armR: [95, 105], legL: WIDE, legR: WIDE });
def('windmill_l', 0.85, { lean: -10, armL: [165, 10], armR: [30, 10], legL: [30, 8], legR: [14, 10], arrowL: 'ccw' });
def('windmill_r', 0.85, { lean: 10, armL: [30, 10], armR: [165, 10], legL: [14, 10], legR: [30, 8], arrowR: 'cw' });
// ---- gold move finishers ---------------------------------------------------
