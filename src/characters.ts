...
export const CAST: CharacterPreset[] = [
  {
    ...
    style: {
      ...
      look: look({ model: 'W_Punk', hair: 'afro', shades: true, pattern: 'halves', pattern2: '#26e5ff' }),
    },
  },
  {
    id: 'blaze', name: 'BLAZE',
    style: {
      ...
      look: look({ model: 'W_Worker', hair: 'spiky', pattern: 'chevron', pattern2: '#ffd23e' }),
    },
  },
  {
    id: 'luna', name: 'LUNA',
    style: {
      ...
      look: look({ model: 'W_Casual', hair: 'bob', pattern: 'stripes', pattern2: '#ff9ad5', skirt: true }),
    },
  },
  {
    id: 'kiko', name: 'KIKO',
    style: {
      ...
      look: look({ model: 'W_Adventurer', hair: 'buns', pattern: 'halves', pattern2: '#ffd23e', skirt: true, headband: '#ff4f9a' }),
    },
  },
  {
    id: 'rex', name: 'REX',
    style: {
      ...
      look: look({ model: 'W_SciFi', hair: 'cap', shades: true, pattern: 'solid' }),
    },
  },
  {
    ...
    style: {
      ...
      look: look({ model: 'W_Formal', hair: 'ponytail', pattern: 'stripes', pattern2: '#ffffff' }),
    },
  },
  {
    ...
    style: {
      ...
      look: look({ model: 'W_Soldier', hair: 'hood', shades: true, pattern: 'solid' }),
    },
  },
  {
    id: 'sol', name: 'SOL',
    style: {
      ...
      look: look({ model: 'W_Suit', hair: 'swoop', pattern: 'chevron', pattern2: '#ffffff', skirt: true }),
    },
  },
];
...
const MODELS = ['W_Casual', 'W_Punk', 'W_Adventurer', 'W_Worker', 'W_Formal',
  'W_Suit', 'W_SciFi', 'W_Soldier', 'W_Witch', 'W_Medieval'];
...
export function autoLook(style: StyleProfile, seed: number): Look {
  return look({
    ...
    tint3d: true,   // your outfit colors on the 3D wardrobe
  });
}
